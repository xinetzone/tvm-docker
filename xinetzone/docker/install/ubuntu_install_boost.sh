...
pushd boost_1_81_0
./bootstrap.sh --with-python="$(which python3.10)"
./b2 install --with-python --with-system --with-filesystem --with-thread --with-regex
popd

ln -s /usr/local/lib/libboost_python310.so.1.81.0 /usr/local/lib/libboost_python.so
ln -s /usr/local/lib/libboost_python310.a /usr/local/lib/libboost_python.a
