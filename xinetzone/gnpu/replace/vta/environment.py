...
class DevContext(object):
    ...
    ALU_OPCODE_SHR = 3
    ALU_OPCODE_MUL = 4    
    ALU_OPCODE_MUL_SHR = 6  #geyijun@20220804
    ALU_OPCODE_SUB = 8      #zzy@20220905
...
class Environment(object):
    ...
    def __init__(self, cfg):
        ...
        self.INP_BUFF_SIZE = self.LOG_INP_BUFF_SIZE * 16
        self.WGT_BUFF_SIZE = self.LOG_WGT_BUFF_SIZE * 256
        self.ACC_BUFF_SIZE = self.LOG_ACC_BUFF_SIZE * 64
        self.OUT_BUFF_SIZE = self.LOG_OUT_BUFF_SIZE * 16
        # bytes per buffer
    ...
    def target_host(self):
        ...
        if self.TARGET in ["xmfpga", "xmfpga_v200", "xmfpga_v500"]:
            return "llvm -mtriple=armv7-none-linux-gnueabihf"
        if self.TARGET == "ultra96":
            return "llvm -mtriple=aarch64-linux-gnu"
        if self.TARGET in ["sim", "tsim", "sim_v2"]:
            return "llvm"
